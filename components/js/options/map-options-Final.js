(function(window,mapster){
  var bounds = [
      ...
      var mapMenuItems = [{
          ...
          icon: '/components/images/search.svg',
      ...
      {
          text: 'Delete',
          icon: '/components/images/deleted.svg',
  ...
  mapster.TRACESFORM = '<p><div class="marker-edit">'+
	'<form action="ajax-save.php" method="POST" name="Traces" id="SaveTraces">'+
        '<label for="pType"><span>Traces :</span> <select name="pType" class="traces-type">'+
  ...
  mapster.CAUSECODEFORM = '<p><div class="marker-edit">'+
        '<form action="ajax-save.php" method="POST" name="SaveMarker" id="SaveMarker">'+
        '<label for="pType"><span>Type :</span> <select name="pType" class="event-type">'+
        /*
        '<optgroup label="Joao">' +
